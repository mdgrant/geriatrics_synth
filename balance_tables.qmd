...
reg_gen_dat |>
  ...
  tab_footnote("RCT: randomized clinical trial;  GRADE: Grades of Recommendation, Assessment, Development, and Evaluation; RR: risk ratio; MD: mean difference; RD: risk difference.") |>
...
tiva_inhaled_dat |>
  ...
  tab_footnote("Complications includes bradycardia, tachycardia, arrhythmia, or unspecified.", locations = cells_body(columns = c(outcome), rows = outcome == "Cardiac complications")) |> 
  tab_footnote(md("Per 100 patients for [higher or highest category or categories compared with lower ones.](kq4.html#patient-satisfaction)"), locations = cells_body(columns = c(est), rows = outcome == "Patient satisfaction"), placement = "right") 
