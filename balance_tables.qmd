...
```{r exp_preop_balance}
#| warning: false
expanded_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "ExpandedPreop", range = "B4:M19") |>
...
#| warning: false
expanded_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "ExpandedPreop", range = "B29:M40") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
