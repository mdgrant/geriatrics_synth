...
```{r exp_preop_balance}
#| warning: false
expanded_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "ExpandedPreop", range = "B4:M17") |>
...
expanded_dat |>
  ...
  tab_footnote(md("RCT: randomized clinical trial; NRSI: nonrandomized studies of interventions;  [GRADE: Grades of Recommendation, Assessment, Development, and Evaluation](soe_gt.html#grade); RR: risk ratio; MD: mean difference.")) |>
...
#| warning: false
expanded_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "ExpandedPreop", range = "B27:M40") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
```{r reg_gen_balance}
#| warning: false
reg_gen_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "RegionalGeneral", range = "B4:L12") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
#| warning: false
reg_gen_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "RegionalGeneral", range = "B24:L34") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
```{r}
#| warning: false
tiva_inhaled_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "TIVAInhaled", range = "B4:M16") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
#| warning: false
tiva_inhaled_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "TIVAInhaled", range = "B29:M37") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
```{r}
#| warning: false
dex_plac_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "DeliriumProph", range = "B4:M10") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
#| warning: false
dex_plac_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "DeliriumProph", range = "B18:M29") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
```{r}
#| warning: false
ket_plac_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "DeliriumProph", range = "B41:M49") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
```{r}
#| warning: false
mel_ram_plac_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "DeliriumProph", range = "B56:M62") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
...
#| warning: false
mel_ram_plac_dat <- readxl::read_excel("data/balance_tables_2023-05-23_mac_mg.xlsx", sheet = "DeliriumProph", range = "B68:M79") |>
  remove_empty(which = "cols") |>
  clean_names() |>
  rename(est = estimate_95_percent_ci) |>
  filter(!if_all(rct:est, ~ is.na(.x))) |>
