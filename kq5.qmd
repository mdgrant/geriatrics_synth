...
# writexl::write_xlsx(kq5_by_arm_tab, "/Users/mgrant/Desktop/kq5_by_arm_tab.xlsx")

# kq5_by_arm_tab |> tabyl(drug_f_nopim)

# save file for use in KQ6

# write_csv(kq5_by_arm_tab |> select(refid, arm_id, agents_up, drug_f, other_spec), "data/kq5_drug_by_arm.csv")
