...
reactable(
  ...
  columns = list(
    ...
    any_top_5 = colDef(name = "Any top 5", width = 100, headerClass = "header", align = "center")
  ),
...
```{r}
bar_chart <- function(label, width = 100, height = 12, fill = "#00bfc4", background = NULL) {
  bar <- div(style = list(background = fill, width = width, height = height))
  chart <- div(style = list(flexGrow = 1, marginLeft = 1, background = background, maxWidth = 100, height = 12), bar)
  div(style = list(display = "flex", alignItems = "left", maxWidth = 100), label, chart)
}

# bar_chart <- function(label, width = "100%", height = 12, fill = "#00bfc4", background = NULL) {
#   bar <- div(style = list(background = fill, width = width, height = height))
#   chart <- div(style = list(flexGrow = 1, marginLeft = 10, background = background, maxWidth = 100, height = 12), bar)
#   div(style = list(display = "flex", alignItems = "center", maxWidth = 100), label, chart)
# }
...
reactable(
  ...
  columns = list(
    ...
    rank4 = colDef(name = "Rank 4", width = 80, headerClass = "header", align = "center"),
    rank5 = colDef(name = "Rank 5", width = 80, headerClass = "header", align = "center"),
    any_top_5 = colDef(name = "Any", align = "left", width = 96, cell = function(value) {
      width <- value * 7.2
      bar_chart(value, width = width, fill = "#B22215", background = "#e1e1e1")
    })
  ),
  theme = reactableTheme(
    borderColor = "#dfe2e5",
...
#         bar_style(width = value / max(data$mpg), fill = "#2c5e77", color = "#FF4040")
#       },
#       align = "left",
