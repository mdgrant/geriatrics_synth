...
<font size = 4> `r table_ref()` Frequency dichotomous outcomes were reported. </font>
...
dichot_dat |>
  ...
  ungroup() |>
  rename_with(~ str_replace(.x, "d_", "")) |>
  rename(
    "Complications" = "complication",
    "Cognitive delay" = "cog_delay",
    "Delirium duration" = "deli_duration",
    "Discharge location" = "disch_location",
    "Opioid use" = "opioid",
