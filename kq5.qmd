...
outcome_dat <- read_csv("data/kq5_outcome.csv") |> 
  clean_names() |> 
  mutate(any_top_5 = rank1 + rank5 + rank4 + rank3 + rank2 + rank1) 
...
reactable(
  ...
  columns = list(
    ...
    rank4 = colDef(name = "Rank 4", width = 80, headerClass = "header", align = "center"),
    rank5 = colDef(name = "Rank 5", width = 80, headerClass = "header", align = "center"),
    any_top_5 = colDef(name = "Top 5", align = "center", width = 96, cell = function(value) {
      width <- value * 6.8
