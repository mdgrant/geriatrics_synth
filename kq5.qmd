...
included_dat |>
  ...
  tab_footnote(
    footnote = md("Various indicates 4 or more different types of surgery."),
...
delirium_tab_fun("benzo_short", "Benzodiazepines (short-acting) — nonrandomized designs", "Coh", "RR <u>aOR</u> (95% CI)") |> 
...
```{r nrsi_overall_study, out.width = "55%", fig.height = 5.25}
