...
dex_by_arm <- drugs_dat |>
  select(refid:interv_desc, matches("^proph_|dexmed"), -study_l) |>
  # timing
...
temp <- dex_by_arm |> 
  select(dexmed_loading:dexmed_postdose)
...
writexl::write_xlsx(dex_by_arm, "/Users/mgrant/Desktop/dex_by_arm.xlsx")
...
drug_compare_dat <- study_arm_dat |> 
  select(refid, design_f_lab, study, arm_id, arm_n, kq6_control_desc:kq6_notes)
  
writexl::write_xlsx(drug_by_arm, "/Users/mgrant/Desktop/drug_by_arm.xlsx")
