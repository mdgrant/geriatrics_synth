...
<foot_mg> Dex: Dexmedetomidine; Ket: Ketamine; Mel/Ram: Melatonin or ramelteon; Benz: benzodiazepine (midazolam or oxazepam); MS: Morphine sulfate; Plac/None: Placebo or no intervention; Prop: Propofol.<br/> Only ramelteon-placebo comparisons with effect similar to melatonin-placebo.</foot_mg>
...
# small study effects; here to have result of Harbord test; china only
...
<foot_mg> Dex: dexmedetomidine; Plac: placebo; RR: risk ratio; D1: bias arising from the randomization process; D2: bias due to deviations from intended interventions; D3: bias due to missing outcome data; D4: bias in measurement of the outcome; D5: bias in selection of the reported result: All: overall risk of bias.<br/> Risk of bias ratings: low +, some concerns ?, high -- . <a id="figure-4"></a><br/> `r paste0("Harbord test for small study effects P = ", formatC(temp_metabias$pval, digits = 4, format = "f"), ".")`<br/> `r paste0("Delirium a designated primary outcome in ", prim_sec_out_fun(prim_delirium, dex_plac_refid), "; a secondary outcome in ", prim_sec_out_fun(sec_delirium, dex_plac_refid), ".")`</foot_mg><br/>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention small study effects for trials conducted in China --- funnel plot and limit meta-analysis. </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention potential small study effects for trials conducted outside of China --- funnel plot. </font>
...
<font size = 4> `r table_ref()` Cognitive dysfunction ≤ 30d incidence and ascertainment in trials of dexmedetomidine. </font>
...
<font size = 4> `r table_ref()` Cognitive dysfunction ≤ 30d incidence and ascertainment in randomized clinical trials of ketamine. </font>
...
<font size = 4> `r figure_ref()` Randomized clinical trials and comparators reporting cognitive dysfunction ≤ 30d. </font>
...
<font size = 4> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention (randomized clinical trials, cognitive dysfunction ≤ 30d assessed postop day 3 or later). </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention according to risk of bias appraisals (randomized clinical trials; cognitive dysfunction ≤ 30d). </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention small study effects --- funnel plot (cognitive dysfunction ≤ 30d). </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Summary risk of bias from randomized clinical trials of dexmedetomidine compared with placebo or no intervention (cognitive dysfunction ≤ 30d). </font>
...
<font size = 4> `r figure_ref()` Ketamine compared with placebo or no intervention (randomized clinical trials, cognitive dysfunction ≤ 30d). </font>
...
<font size = 4> `r figure_ref()` Network meta-analysis of cognitive dysfunction ≤ 30d including all comparators.</font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Comparison adjusted funnel plot (cognitive dysfunction ≤ 30d). </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Comparison of direct and indirect evidence in network meta-analysis (node splitting forest plot, cognitive dysfunction ≤ 30d). </font>
...
<font size = 4> `r table_ref()` Cognitive dysfunction \> 30d and ascertainment reported in dexmedetomidine and melatonin trials. </font>
...
adverse_meta_dat <- adverse_events_dat |>
  ...
  mutate(
    ...
    complication = factor(complication, levels = c("bradycardia", "other arrhythmia", "myoinfarct", "cardarr", "kidneyinj", "stroke", "pulm", "pneum", "pulcongest", "pe", "respfail", "intub"), labels = c("Bradycardia", "Other arrhythmia", "MI", "Cardiac Arrest", "AKI", "Stroke", "Pulmonary", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure", "Reintubation"))
  ) |>
...
<font size = 4> `r table_ref()` Other reported complications in dexmedetomidine studies --- cardiac, MI, stroke, pulmonary, pneumonia, and acute kidney injury (randomized clinical trials unless noted). </font>
...
adverse_events_dat |>
  ...
  mutate(
    complication = factor(complication,
      levels = c("Other arrhythmia", "MI", "Cardiac Arrest", "AKI", "Stroke", "Pulmonary", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure", "Reintubation"),
      labels = c("Other Arrhythmia", "MI", "Cardiac Arrest", "AKI", "Stroke", "Pulmonary", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure", "Reintubation")
    ),
  ...
  group_by(complication) |>
  gt(id = "one") |>
  row_group_order(groups = c("Other Arrhythmia", "MI", "Cardiac Arrest", "Stroke", "AKI", "Pulmonary", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure", "Reintubation")) |>
  cols_hide(c(refid, year, study, arm_id, n, study, study_compl, design_f_lab)) |>
  cols_label(
    study_l          = "Study",
    arm_n            = " N",
...
```{r complication_hypo_meta, fig.width = 14, fig.height = 6.5, fig.align = "left"}
#| warning: false
# RESUME: hypotension
...
<font size = 4> `r figure_ref()` Risk ratios for other complications --- cardiac, stroke, pulmonary, and acute kidney injury (dexmedetomidine versus placebo or no interventions; randomized clinical trials). </font>

```{r complication_meta,  fig.width = 14, fig.height = 15, fig.align = "left"}
adverse_meta <- metabin(
  n_Dex, arm_n_Dex, n_Plac, arm_n_Plac,
