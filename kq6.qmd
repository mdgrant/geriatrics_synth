...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> Exploratory network meta-analysis examining timing of dexmedetomidine administration. </font>
...
<foot_mg> Dex: dexmedetomidine; Plac: placebo. <br/> `r paste0("Harbord test for small study effects P = ", digit2(temp_metabias$pval), ".")` </foot_mg><br/>
