...
dex_by_arm <- drugs_dat |>
  ...
  mutate(dex_groups = str_c(surgs_single_f, " - ", design_f_lab))
...
temp_limit_meta <- limitmeta(temp_other_meta, method.adjust = "betalim") # note RR 2024-04-15
...
<caption_mg> `r figure_ref()`  </caption_mg>
...
```{r complication_brady_meta, fig.width = 16, fig.height = 6, fig.align = "left"}
#| warning: false
...
```{r complication_brady_meta_rd, fig.width = 16, fig.height = 6, fig.align = "left"}
...
```{r complication_hypo_meta, fig.width = 16.5, fig.height = 6.75, fig.align = "left"}
#| warning: false 
# RESUME: hypotension
...
```{r complication_hypo_meta_rd, fig.width = 16, fig.height = 6.8, fig.align = "left"}
adverse_meta_rd <- update(adverse_meta, sm = "RD")
...
```{r complication_meta,  fig.width = 16, fig.height = 12, fig.align = "left"}
adverse_meta <- metabin(
  n_Dex, arm_n_Dex, n_Plac, arm_n_Plac,
...
```{r complication_ram_meta,  fig.width = 16, fig.height = 2.5, fig.align = "left"}
...
```{r los_meta, fig.width = 16, fig.height = 3, fig.align = "left"}
...
```{r los_dex_meta, fig.width = 16, fig.height = 5.5, fig.align = "left"}
...
```{r dex_mort_meta, fig.dim = c(16, 6), fig.align = "center"}
...
```{r mel_ram_mort_meta, fig.dim = c(16, 5.5), fig.align = "center"}
# ```{r nma_dat, out.width = 50%, out.height = 100%}
