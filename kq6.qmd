...
PublicationBias::significance_funnel(yi = dat$yi, vi = dat$vi, favor_positive = FALSE, alpha_select = 0.05) + # scale_x_continuous(labels=latex2exp::TeX(c("$Test^{89}$","$Oh_{i,j}^{99}$")))
  ...
  xlab("RR") + 
  scale_y_continuous() + ylab("log(SE)") +
  theme(
...
png("assets/mel_ram_plac_meta_funnel.png", width = 8.5, height = 5.5, units = "in", res = 300)
...
```
![](assets/mel_ram_plac_meta_funnel.png){fig.align="left" width="70%"}
