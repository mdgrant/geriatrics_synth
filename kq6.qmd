...
<font size = 4> `r table_ref()` Summary of randomized clinical trials according to country. </font>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <font size = 4> `r figure_ref()` Delirium incidence in dexmedetomidine trials conducted in China versus other countries. </font>
...
![](docs/assets/subgroup_summary.png){#subgroup_summary fig-align="center" width="750"}
...
<foot_mg> MS: morphine sulfate; Mid: midazolam; Prop: propofol; Plac: placebo; Preop: preoperative; Induct: induction;  Intra: intraoperative; Postop: postop.
<br/> Excludes Lee 2018b pregabalin arms (pregabalin alone and with dexmedetomidine). </foot_mg>
:::
