...
```{r mortality_base}
mortality_total_tab_fun <- function(refids, mort_est){
  ...
  mortality_rr_ref <-
    dichot_dat |>
      ...
      select(refid, refid_c, arm_id, mort_n, arm_n) |>
      filter(!is.na(mort_n)) |>
...
mortality_total_tab_fun(kq6_refid, morthosp_n)
mortality_total_tab_fun(kq6_refid, mort30_n)
mortality_total_tab_fun(kq6_refid, mort90_n)
mortality_total_tab_fun(kq6_refid, mort1_n)
```



```{r mortality_total_dex_tab}
# CODE: mortality dexmedetomidine
