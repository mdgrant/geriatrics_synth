...
```{r dncr_dex_plac_meta, fig.width = 14, fig.height = 6, fig.align = "left", warning = TRUE}
#| eval: true
...
```{r dncr_ket_plac_meta, fig.width = 14, fig.height = 4.5, fig.align = "left", warning = TRUE}
#| eval: true
...
<font size = 4> `r figure_ref()` Risk ratio for complications — cardiac, stroke, pulmonary, and acute kidney injury (dexmedetomidine versus placebo or no interventions; randomized clinical trials except and Li 2020). </font>
