...
```{r dncr_dex_plac_meta, fig.width = 14, fig.height = 7.2, fig.align = "left", warning = FALSE}
#| eval: true
dex_meta_dat <- pairs_dat |>
  arrange(time, year, study) |> 
...
Note: Gao 2021 identified in the search was presumably an overlapping sample of Gao 2020 and excluded.
</foot_mg><br/>
...
```{r dncr_ket_plac_meta, fig.width = 14, fig.height = 5.0, fig.align = "left", warning = FALSE}
#| eval: true
