...
#   mutate(
#     delirium_day_max = pmax(delirium_n1, delirium_n2, delirium_n3, delilast_n)
#   ) |> 
#   filter(is.na(delitotal_n) & !is.na(delirium_day_max))
  
delirium_meta_dat <- dichot_dat |>
  mutate(
    delitotal_n = ifelse(refid %in% c(69, 13568), pmax(delirium_n1, delirium_n2, delirium_n3, delilast_n), delitotal_n)
  ) |> 
...
forest(dex_plac_meta,
  ...
  text.addline2 = "He 2018 and Huyan 2019 incidence proportion based on the maximum daily reported."
)
```
...
temp_metareg <- metareg(dex_plac_meta_china)
...
forest(dex_plac_meta_china,
  ...
  addrows.below.overall = 4,
  text.addline1 = paste0("Harbord test for small study effects P = ", digit2(temp_metabias$pval)),
  text.addline2 = paste0("Residual heterogeneity meta regression including country (China vs. other) ", "I²", " = ", digit0(temp_metareg$I2), "%"))
...
```{r nma_mel_ram_dat, fig.width = 14, fig.height = 6, fig.align = "left"}
# ```{r nma_dat, out.width = 50%, out.height = 100%}
# risk of bias
