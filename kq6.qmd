...
<font size = 4> `r figure_ref()` Risk ratio for other complications --- cardiac, stroke, pulmonary, and acute kidney injury (dexmedetomidine versus placebo or no interventions; randomized clinical trials). </font>
