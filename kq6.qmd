...
```{r component_nma}
# RESUME: 2023-10-02 ! Length of argument 'seq' different from number of treatments.
...
```{r complication_meta,  fig.width = 14, fig.height = 14, fig.align = "left"}
adverse_meta <- metabin(
  n_Dex, arm_n_Dex, n_Plac, arm_n_Plac,
...
<foot_mg> RR: risk ratio. <br/> Similar arms combined for Zhao 2020. </foot_mg>
