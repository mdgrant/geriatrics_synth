...
png("assets/kq5_dex_plac_meta_funnel_limit_mort.png", width = 10.5, height = 7.5, units = "in", res = 300)
par(bty = "n", xaxt = "s", yaxt = "s", mar = c(4, 4, 2, 1))
...
trim_image("kq5_dex_plac_meta_funnel_limit_mort.png")

```
![](assets/kq5_dex_plac_meta_funnel_limit_mort.png){fig.align="left" width="65%"}
:::
