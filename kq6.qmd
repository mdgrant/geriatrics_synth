...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <caption_mg> `r figure_ref()` Dexmedetomidine compared with placebo or no intervention --- **small study effects int rials conducted outside of China**. </caption_mg>
...
<foot_mg> Estimates (odds ratio and 95% CI) from random effects model. Too few studies for tests of small study effects.</foot_mg>
:::
