...
kq6_refid <- kq6_refid[!kq6_refid %in% c(13734, 13630, 2314, 17151, 16753, 13171, 18900, 18493, 2396)] # Fan 2017b rhythim, Gao 2021 5269 ? duplicate of Gao 2020 1819, Xuan 2016 "Eligible patients were more than 60 years old with joint replacement surgery in ICU."; Sun 2019 2314 retracted; Ding 2015 16753 retracted; Xu 2022 17151 case control study no informative data; 13171 Mahrose 2021 nrc melatonin+dexmedetomidine vs dexmedetomidine; Wittwer 2023 ketamine+dexmedetomidine vs dexmedetomidine; 18493 Javaherforooshzadeh 2023 dex vs dex-melatonin; 2396 Shehabi dex vs MS
...
```{r drugs_by_arm}
#| message: false
# CODE: * drugs & recode drugs/comparators so that usable; "other" category recode to comparator 
...
# TODO: He 2018 midazolam arm and Sultan 2010; keep for delirium incidence in kq56 file below
...
# calculated vs reported percentages; verified 2024-04-15
...
# old code
# delirium_total_ket_gt <- delirium_total_gt_fun("Ket")
# tab_info(delirium_total_gt_ket)
# delirium_total_ket_gt |>
...
```{r nma_dat, fig.width = 14, fig.height = 9.5, fig.align = "left", warning = TRUE}
...
temp_china_meta <- update(dex_plac_meta, subgroup = NULL, sm = "RR", subset = china_vs_other == "China")
...
temp_other_meta <- update(dex_plac_meta, subgroup = NULL, sm = "RR", subset = china_vs_other != "China")
...
```{r nma_dat_china, fig.width = 14, fig.height = 13, fig.align = "left"}
...
temp_meta <- update(dex_plac_meta, sm = "RR")
# temp_meta <- update(dex_plac_meta, sm = "RR", subset = study != "Turan 2020")

# metabias(temp_meta, method = "Harbord") = 0.0029 no Turan
...
# copas(temp_meta)
# trimfill(temp_meta)
# metabias(dex_plac_meta, method = "Harbord")
...
temp_limit_meta <- limitmeta(temp_other_meta, method.adjust = "betalim") # note RR 2024-04-1511
...
net1 <- netmeta(TE, seTE, treat1, treat2, studlab,
  ...
  ref = "Plac",
  sm = "OR",
  trts = c("Preop/Induct/Intra", "Preop/Induct/Intra|Postop", "Postop", "Mid", "MS", "Prop", "Plac", "Other")
)
...
netgraph(net1,
  ...
  col.points = "#F39C12",
  number.of.studies = TRUE,
  seq = c("Preop/Induct/Intra", "Preop/Induct/Intra|Postop", "Postop", "Mid", "MS", "Prop", "Plac", "Other"),
  rescale.pointsize = TRUE,
  # cex.points = c(1, 2, 3, 4, 5),
  # cex.points = node_size$n/40,
  # cex.points = netmeta_melram_nma$n.trts,
...
```{r los_meta, fig.width = 16, fig.height = 6, fig.align = "left"}
...
```{r los_dex_meta, fig.width = 16, fig.height = 7.5, fig.align = "left"}
