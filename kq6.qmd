...
2023-04-20 delayed neurocognitive recovery and neurocognitive disorders pairwise meta-analysis added
...
kq6_refid <- kq6_refid[kq6_refid != 13734] # Fan 2017b rhythim 
...
0.5 added to cells of studies without events in one arm.<br/>`r paste0("Harbord test for small study effects P = ", digit2(temp_metabias$pval), ".")`<br/> `r paste0("Delirium a designated primary outcome in ", prim_sec_out_fun(prim_pocd, dex_meta_dat$refid), "; a secondary outcome in ", prim_sec_out_fun(sec_pocd, dex_meta_dat$refid), ".")`</foot_mg><br/>
