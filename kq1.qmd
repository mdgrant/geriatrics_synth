...
```{r dc_loc_meta, fig.width = 14, fig.height = 4.5, fig.align = "left", warning = TRUE}
...
```{r dc_loc_nrsi_meta, fig.width = 14, fig.height = 4.5, warning = TRUE}
#| fig-align: "left"
...
```{r mort_rct_meta, fig.dim = c(14, 4.5), fig.align = "center"}
...
```{r mort_nrsi_meta, fig.dim = c(14, 9.5), fig.align = "center"}
