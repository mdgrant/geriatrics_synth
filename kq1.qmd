...
complication_forest_fun(temp_meta, use_predictive = FALSE, text.addline1 = "*Randomized clinical trial", text.addline2 = risk_diff_meta_rr())
dev.off()
...
complication_forest_fun(temp_meta, use_predictive = TRUE, text.addline1 = risk_diff_meta_rr())
dev.off()
...
forest(mort_rct_1yr_meta,
  ...
  xlab = "Favors: Expanded                         Standard        ",
  addrows.below.overall = 4,
  text.addline2 = risk_diff_meta_rr(mort_rct_1yr_meta)
)
dev.off()
...
forest(mort_nrsi_1yr_meta,
  ...
  xlab = "Favors: Expanded                         Standard        ",
  addrows.below.overall = 4,
  text.addline2 = risk_diff_meta_rr(mort_nrsi_1yr_meta)
)
