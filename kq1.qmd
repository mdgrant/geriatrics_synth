...
expanded_combined |> 
  ...
  # tab_footnote("When a comprehensive geriatric assessment (CGA) was conducted, all components were presumed included. ", locations = cells_column_labels(columns = "gen_comp"))
