...
interventions_dat <- study_arm_dat |>
  ...
  filter(arm == "Exp") |>
  select(staff_comorbid, staff_inappmed, staff_geriatrician, staff_multidisc, staff_supplement, staff_treatplan, staff_haloperidol, pacu_screen, pt_nutr, pt_mobility, pt_social, pt_expect, pt_surgery, pt_palliative) |>
  mutate(
