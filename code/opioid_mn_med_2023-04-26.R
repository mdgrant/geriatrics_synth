...
opioid_dat <- contin_dat |>
  ...
  select(refid, study, arm, arm_id, arm_n, opioid_m1:opioid_iqru1, opioid_time1, opioid_m2:opioid_iqru2, opioid_time2, opioid_m3:opioid_iqru3, opioid_time3, opioid_m_all:opioid_iqru_all, opioid_time_all)
