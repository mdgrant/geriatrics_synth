...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for myocardial infarction (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
<!-- <caption_mg> `r figure_ref()` **Risk difference (per 1000)** for cardiac arrest (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg> -->
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for stroke (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for renal complications (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
<!-- <caption_mg> `r figure_ref()` **Risk difference (per 1000)** for pulmonary complications (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg> -->
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for pneumonia (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for pulmonary embolism (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for hospital or 30-day mortality (neuraxial versus general; randomized clinical trials). </caption_mg>
...
<caption_mg> `r figure_ref()` **Risk difference (per 1000)** for 90-day mortality (neuraxial versus general; randomized clinical trials). </caption_mg>
