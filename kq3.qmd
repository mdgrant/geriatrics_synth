...
<!-- <caption_mg> `r figure_ref()` Risk ratio for composite measures of cardiac complications (regional versus general anesthesia; randomized clinical trials). </caption_mg> -->
...
<caption_mg> `r figure_ref()` Risk difference in patient satisfaction (general versus regional anesthesia; randomized clinical trials). </caption_mg>
...
<caption_mg> `r figure_ref()` Summary risk of bias assessments for randomized clinical trials. </caption_mg>

```{r rob2_summary_overall, fig.height = 6, out.width = "60%"}
