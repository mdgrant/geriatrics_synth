...
png("assets/kq3_complication_mi.png", width = 7.87, height = 3.8, units = "in", res = 300)
...
<caption_mg> `r figure_ref()` **Risk ratio** for bradycardia (neuraxial versus general anesthesia; randomized clinical trials). </caption_mg>
...
png("assets/kq3_complication_brady.png", width = 7.87, height = 3.2, units = "in", res = 300)
...
png("assets/kq3_complication_stroke.png", width = 7.87, height = 3.0, units = "in", res = 300)
...
png("assets/kq3_complication_renal.png", width = 7.87, height = 3.2, units = "in", res = 300)
temp_meta <- complication_meta_fun("AKI/Renal Failure", use_hakn = FALSE, predictive = FALSE)
complication_forest_fun(temp_meta, predictive = FALSE, risk_diff_meta_rr())
dev.off()
...
png("assets/kq3_complication_pneumonia.png", width = 7.87, height = 4.2, units = "in", res = 300)
...
png("assets/kq3_complication_pe.png", width = 7.87, height = 4, units = "in", res = 300)
temp_meta <- complication_meta_fun("Pulmonary Embolism", use_hakn = TRUE, predictive = FALSE)
complication_forest_fun(temp_meta, "Similar arms combined for Liang 2017.", text.addline2 = risk_diff_meta_rr())
dev.off()
...
# summary(plac_meta)
png("assets/kq3_satis_meta.png", width = 8.1, height = 4.4, units = "in", res = 300)
forest(satis_meta,
  allstudies = TRUE,
  # random = FALSE,
  label.e = "Neuraxial     ",
...
# summary(plac_meta)
png("assets/kq3_mort_rct_meta.png", width = 8.8, height = 7.1, units = "in", res = 300)
...
png("assets/kq3_mort_rct_rd_meta.png", width = 8.84, height = 6.9, units = "in", res = 300)
...
png("assets/kq3_mort_rct_90d_meta.png", width = 8.84, height = 3.05, units = "in", res = 300)
forest(mort_rct_meta,
  allstudies = TRUE,
  # random = FALSE,
  label.e = "Neuraxial",
