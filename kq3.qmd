...
![](assets/kq3_delirium_meta_forest.png){fig.align="left" width="71%"}
...
complication_forest_fun(temp_meta, "Similar arms combined for Liang 2017.", text.addline2 = rd_ci_from_meta(temp_meta, pscale = 1000, digits = 1))
dev.off()
```
...
complication_forest_fun(temp_meta, predictive = FALSE, rd_ci_from_meta_sub(temp_meta, pscale = 1000, digits = 1))
dev.off()
...
complication_forest_fun(temp_meta, predictive = FALSE, rd_ci_from_meta(temp_meta, pscale = 1000, digits = 1))
dev.off()
...
complication_forest_fun(temp_meta, predictive = TRUE, rd_ci_from_meta(temp_meta, pscale = 1000, digits = 1))
dev.off()
...
complication_forest_fun(temp_meta, "Similar arms combined for Liang 2017. Hip fracture studies only RR 0.48 (0.33–0.70).", text.addline2 = rd_ci_from_meta(temp_meta, pscale = 1000, digits = 1))
dev.off()
