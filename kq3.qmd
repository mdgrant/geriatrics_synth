...
<font size = 4> `r table_ref()` Reported complications for regional versus general anesthesia — cardiac, MI, stroke, pulmonary, pneumonia, acute kidney injury. </font>
...
cardiac_meta_dat <- adverse_meta_dat |>
  ...
  mutate(
    n = case_when(
      study == "Bielka 2021" & arm_id == 2 ~ collapse_dichot(adverse_meta_dat, "Zhao 2020", c(2, 3), n),
      study == "Shin 2020" & arm_id == 2 ~ collapse_dichot(adverse_meta_dat, "Shin 2020", c(1, 2), n),
      .default = n
    ),
    arm_n = case_when(
      study == "Bielka 2021" & arm_id == 2 ~ collapse_dichot(adverse_meta_dat, "Bielka 2021", c(2, 3), arm_n),
...
```{r cardiac_meta, warning = FALSE, fig.width = 14, fig.height = 4.75, fig.align = "left"}
...
```{r reg_gen_meta_funnel_limit_mort, fig.dim = c(7, 5.5), out.width = "70%", fig.align = "center"}
