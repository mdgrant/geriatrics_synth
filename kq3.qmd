...
reg_gen_dat |>
  ...
  tab_style(style = cell_text(align = "left"),        locations = cells_body(columns = c(measure))) |>
...
<caption_mg> `r table_ref()` Physical functional status for regional versus general anesthesia. </caption_mg>
...
```{r complication_pneumonia, fig.width = 14, fig.height = 6.5, fig.align = "left"}
...
```{r complication_pneumonia_rd, fig.width = 14, fig.height = 6.5, fig.align = "left"}
