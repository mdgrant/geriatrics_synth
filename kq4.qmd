...
adverse_events_gt_dat <- adverse_events_dat |>
  ...
  mutate(complication = factor(complication, levels = c("cardiac", "myoinfarct", "cardarr", "kidneyinj", "pneum", "pulcongest", "pe", "respfail"), labels = c("Other Cardiac", "MI", "Cardiac Arrest", "AKI", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure"))) |>
...
<!-- <font size = 4> Risk ratio for composite measures of cardiac complications (TIVA versus inhaled anesthesia; randomized clinical trials). </font> -->
