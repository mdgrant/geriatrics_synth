...
```{r complications_check_to_excel, eval = FALSE}
...
complication_forest_or(temp_meta, big.mark = ",", text.addline2 = risk_diff_meta_or_kq4())
dev.off()
...
complication_forest_rr(temp_meta, random = FALSE, big.mark = ",", text.addline2 = risk_diff_meta_rr_kq4())
dev.off()
...
complication_forest_rr(temp_meta, big.mark = ",", text.addline2 = risk_diff_meta_rr_kq4())
dev.off()
...
complication_forest_or(temp_meta, big.mark = ",", random = FALSE, text.addline2 = risk_diff_meta_or_kq4())
dev.off()
...
complication_forest_or(temp_meta, big.mark = ",", text.addline2 = risk_diff_meta_or_kq4(digits = 1))
dev.off()
...
complication_forest_or(temp_meta, use_predictive = TRUE, text.addline2 = risk_diff_meta_or_kq4())
dev.off()
...
complication_forest_or(temp_meta, use_predictive = TRUE, big.mark = ",", text.addline2 = risk_diff_meta_or_kq4(digits = 1))
dev.off()
...
complication_forest_or(temp_meta, use_predictive = TRUE, big.mark = ",", text.addline2 = risk_diff_meta_or_kq4(digits = 2))
dev.off()
...
# riskdiff_ci_from_meta_rr_kq4(temp_meta, digits = 2)
...
forest(mort_nrsi_meta,
  ...
  big.mark = ",",
  method.random.ci = "HK",
  text.addline2 = paste0("Approximate pooled risk difference ", riskdiff_ci_from_meta_rr_kq4(temp_meta, digits = 2))
)
dev.off()
