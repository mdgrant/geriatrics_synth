...
included_dat |>
  ...
  tab_footnote(footnote = md("Various indicates either described as various or 4 or more different types of surgery."), locations = cells_column_labels(columns = surgs)) |>
...
<font size = 4> `r table_ref()` Reported complications in TIVA versus inhaled anesthesia --- cardiac, pulmonary, and renal (TIVA versus inhaled; randomized and nonrandomized designs). </font>
...
adverse_events_gt_dat <- adverse_events_dat |>
  ...
  mutate(complication = factor(complication, levels = c("cardiac", "myoinfarct", "cardarr", "stroke", "kidneyinj", "pneum", "pulcongest", "pe", "pthorax", "respfail"), labels = c("Other Cardiac", "MI", "Cardiac Arrest", "Stroke", "AKI", "Pneumonia", "Pulmonary Congestion", "PE", "Pneumothorax", "Respiratory Failure"))) |>
...
adverse_meta_wide_dat <- adverse_meta_dat |> 
  ...
  mutate(
    ...
    complication_nodesign = factor(complication_nodesign, levels = c("Cardiac", "MI", "Cardiac Arrest", "Pneumonia", "Pulmonary Congestion", "PE", "Respiratory Failure", "AKI"), labels = c("Cardiac", "MI", "Cardiac Arrest", "Pneumonia", "Pulmonary Congestion", "Pulmonary Embolism", "Respiratory Failure", "Renal"))
  )
...
<font size = 4> `r figure_ref()` Risk ratio for renal complications (TIVA versus inhaled anesthesia; nonrandomized studies). </font>
