...
png("assets/kq4_mort_rct.png", width = 8.875, height = 3.6, units = "in", res = 300)
...
png("assets/kq4_mort_nrsi.png", width = 9.1, height = 3.8, units = "in", res = 300)
