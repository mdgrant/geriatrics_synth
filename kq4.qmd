...
kq4_refid <- kq4_refid[!kq4_refid %in% c(18304)]
...
tiva_inhaled_dat |>
  ...
  tab_footnote("RCT: randomized controlled trial; NRSI: non-randomized study of intervention; GRADE: Grading of Recommendations Assessment, Development and Evaluation; Est: effect estimate; CI: confidence interval.") |>
...
<font size = 4> Benefits, harms, and strength of evidence (GRADE) for TIVA versus inhalation anesthesia. </font>
...
<font size = 4> Included complications and strength of evidence (GRADE) for TIVA versus inhalation anesthesia. </font>
...
<font size = 4> `r table_ref()` Delirium incidence and days of ascertainment during hospitalization in studies comparing TIVA with inhalation anesthesia. </font>
...
<font size = 4> `r figure_ref()` Delirium incidence (randomized clinical trials). </font> 
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <caption_mg> `r figure_ref()` Delirium incidence summary risk of bias from randomized clinical trials comparing TIVA to inhalation anesthesia (weighted). </caption_mg>
...
::: {.callout-note collapse="true" appearance="minimal" icon="false"}
#### <caption_mg> `r figure_ref()` Delayed neurocognitive recovery summary risk of bias from randomized clinical trials comparing TIVA to inhalation anesthesia (weighted). </caption_mg>
...
<font size = 4> `r table_ref()` Postoperative neurocognitive disorder (cognitive dysfunction after 30 days) and ascertainment (cohort studies). </font>
...
<font size = 4> `r table_ref()` Complications following TIVA versus inhalation anesthesia --- cardiac, pulmonary, and renal (randomized and nonrandomized designs). </font>
...
<font size = 4> `r figure_ref()` Odds ratio for myocardial infarction (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for cardiac arrest (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for bradycardia (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for hypotension (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Odds ratio for stroke (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Odds ratio for acute kidney injury complications (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for pneumonia (randomized clinical trials). </font>
...
<font size = 4> `r figure_ref()` Odds ratio for pulmonary embolism (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Odds ratio for respiratory failure (randomized and nonrandomized studies). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for patient satisfaction (randomized clinical trials). </font>
...
<font size = 4> `r figure_ref()` Mean difference in length of stay (randomized clinical trials). </font>
...
<font size = 4> `r figure_ref()` Mean difference in length of stay (nonrandomized designs). </font>
...
<caption_mg> `r table_ref()` Discharge location in study comparing TIVA with inhaled anesthesia. </caption_mg>
...
<font size = 4> `r figure_ref()` Risk ratio for hospital or 30-day mortality (randomized clinical trials). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for hospital or 30-day mortality (nonrandomized designs). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for 1-year mortality (randomized and nonrandomized). </font>
