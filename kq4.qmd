...
<font size = 4> `r table_ref()` Neurocognitive disorders and ascertainment (TIVA vs. inhaled; prospective cohort studies). </font>
...
<font size = 4> `r table_ref()` Reported complications in TIVA versus general anesthesia — cardiac, pulmonary, and acute kidney injury (TIVA vs. inhaled; randomized and nonrandomized designs). </font>
...
<font size = 4> `r figure_ref()` Relative odds complications in TIVA versus general anesthesia — cardiac, pulmonary, and acute kidney injury (TIVA vs. inhaled; combined randomized and nonrandomized designs). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for hospital or 30-day mortality (TIVA vs. inhaled; randomized clinical trials). </font>
...
<font size = 4> `r figure_ref()` Risk ratio for hospital or 30-day mortality (TIVA vs. inhaled; nonrandomized designs). </font>
...
```
<foot_mg> Note for Yoshimura 2022 naïve risk ratio, but identical to odds ratio reported respecting propensity matching.</foot_mg> 
...
<font size = 4> `r figure_ref()` Mean difference in lengths of stay from randomized clinical trials. </font>
...
<font size = 4> `r figure_ref()` Mean difference in lengths of stay from nonrandomized designs. </font>
