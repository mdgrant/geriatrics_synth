...
![](assets/regional_general_balance_2023-05-21.png){fig-align="left" width="6in"}
...
#| include: false
col_types_soe <- c("numeric", rep("text", 5), "numeric", rep("text", 19))
soe_kq4.dat <- readxl::read_xlsx("data/soe_2023-04-27_local.xlsx", range = "A1:Z21", sheet = "soe_kq4_sp", col_types = col_types_soe) |>
  filter(!n %in% c(4.52, 4.71)) |>
  clean_names() |>
  mutate(
    n_s = paste0(n_studies, " <br/>(", format(n_pts, big.mark = ","), ")"),
    n = paste0(n, outcome),
