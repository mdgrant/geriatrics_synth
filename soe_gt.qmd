...
```{r soeKq3Data}
#| include: false
## soeKq3Data (updated 2022/01/20 09:18) ----------------------------------
col_types_soe <- c("numeric", rep("text", 5), "numeric", rep("text", 19))
soe_Kq3.dat <- readxl::read_xlsx("data/soe_2023-04-27_local.xlsx", range = "A1:Z4", sheet = "soe_kq3", col_types = col_types_soe) |>
  clean_names() |>
  mutate(
...
<font size = 4> `r table_ref()` Strength of evidence for outcomes relevant to regional versus general anesthesia. </font>

```{r kq3SOE_gt}
#| include: true
#| echo: false

## kq3SOE --------------------------------------------- (2023-05-03 11:17) @----
soe_summary |>
